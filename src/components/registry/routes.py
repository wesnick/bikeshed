...
jinja = get_jinja("src/components/registry/templates")
...
@router.get("/")
@jinja.hx('sidebar_widget.html.j2')
async def registry_component(request: Request) -> dict:
    """This route serves the templates sidebar widget for htmx requests."""
...
@jinja.hx('resources_list.html.j2')
...
@jinja.hx('resource_templates_list.html.j2')
...
@jinja.hx('mcp_servers_list.html.j2')
